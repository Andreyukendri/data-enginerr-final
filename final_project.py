...
# Spark References
SPARK_CODE = ("gs://us-central1-final-project-c40fddea-bucket/spark/final_project_spark.py")
...
with models.DAG(
    ...
    load_country_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        bucket="file_final_projectt",
        source_objects=["raw/uscountry.parquet/part*"],
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.countries",
    ...
    load_port_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.ports",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_state_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.states",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_weather_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.weathers",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_demographic_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.demographic",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_airportcode_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.airport_codes",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_immigration_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-andre:FINAL_PROJECT_STAGING.immigration_data",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    transform_country_to_dim = BigQueryOperator(
        ...
        params = {
            "project_id": "final-project-andre",
